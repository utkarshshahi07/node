...
## 2025-02-12, Version 22.14.0 'Jod' (LTS), @aduh95
...
* \[[`1d1f8804be`](https://github.com/nodejs/node/commit/1d1f8804be)] - **(SEMVER-MINOR)** **module**: add `findPackageJSON` util (Jacob Smith) [#55412](https://github.com/nodejs/node/pull/55412)
* \[[`396a830df7`](https://github.com/nodejs/node/commit/396a830df7)] - **(SEMVER-MINOR)** **process**: add process.ref() and process.unref() methods (James M Snell) [#56400](https://github.com/nodejs/node/pull/56400)
...
* \[[`36b2210a9b`](https://github.com/nodejs/node/commit/36b2210a9b)] - **child\_process**: fix parsing messages with splitted length field (Maksim Gorkov) [#56106](https://github.com/nodejs/node/pull/56106)
...
* \[[`6f9e1822eb`](https://github.com/nodejs/node/commit/6f9e1822eb)] - **deps**: update corepack to 0.31.0 (Node.js GitHub Bot) [#56795](https://github.com/nodejs/node/pull/56795)
* \[[`9b41d74317`](https://github.com/nodejs/node/commit/9b41d74317)] - **deps**: move inspector\_protocol to deps (Chengzhong Wu) [#56649](https://github.com/nodejs/node/pull/56649)
* \[[`36f06472aa`](https://github.com/nodejs/node/commit/36f06472aa)] - **deps**: macro ENODATA is deprecated in libc++ (Cheng) [#56698](https://github.com/nodejs/node/pull/56698)
* \[[`80b41ec021`](https://github.com/nodejs/node/commit/80b41ec021)] - **deps**: fixup some minor coverity warnings (James M Snell) [#56612](https://github.com/nodejs/node/pull/56612)
* \[[`b5d8cbdf4a`](https://github.com/nodejs/node/commit/b5d8cbdf4a)] - **deps**: update libuv to 1.50.0 (Node.js GitHub Bot) [#56616](https://github.com/nodejs/node/pull/56616)
...
* \[[`c275f28db7`](https://github.com/nodejs/node/commit/c275f28db7)] - **doc**: update macOS and Xcode versions for releases (Michaël Zasso) [#56337](https://github.com/nodejs/node/pull/56337)
* \[[`2b1ba6f32c`](https://github.com/nodejs/node/commit/2b1ba6f32c)] - **doc**: add note for features using `InternalWorker` with permission model (Antoine du Hamel) [#56706](https://github.com/nodejs/node/pull/56706)
* \[[`e0980fcbbb`](https://github.com/nodejs/node/commit/e0980fcbbb)] - **doc**: add entry to changelog about SQLite Session Extension (Bart Louwers) [#56318](https://github.com/nodejs/node/pull/56318)
* \[[`2ecd96d2c2`](https://github.com/nodejs/node/commit/2ecd96d2c2)] - **doc**: move anatoli to emeritus (Michael Dawson) [#56592](https://github.com/nodejs/node/pull/56592)
* \[[`cb5fa7cfc2`](https://github.com/nodejs/node/commit/cb5fa7cfc2)] - **doc**: fix styles of the expandable TOC (Antoine du Hamel) [#56755](https://github.com/nodejs/node/pull/56755)
* \[[`a661224f7f`](https://github.com/nodejs/node/commit/a661224f7f)] - **doc**: add "Skip to content" button (Antoine du Hamel) [#56750](https://github.com/nodejs/node/pull/56750)
* \[[`db2c4f0c6e`](https://github.com/nodejs/node/commit/db2c4f0c6e)] - **doc**: improve accessibility of expandable lists (Antoine du Hamel) [#56749](https://github.com/nodejs/node/pull/56749)
* \[[`73dcd45441`](https://github.com/nodejs/node/commit/73dcd45441)] - **doc**: add note regarding commit message trailers (Dario Piotrowicz) [#56736](https://github.com/nodejs/node/pull/56736)
* \[[`29c04fb39a`](https://github.com/nodejs/node/commit/29c04fb39a)] - **doc**: fix typo in example code for util.styleText (Robin Mehner) [#56720](https://github.com/nodejs/node/pull/56720)
* \[[`6938a0b6bb`](https://github.com/nodejs/node/commit/6938a0b6bb)] - **doc**: fix inconsistencies in `WeakSet` and `WeakMap` comparison details (Shreyans Pathak) [#56683](https://github.com/nodejs/node/pull/56683)
* \[[`fe8e7eebee`](https://github.com/nodejs/node/commit/fe8e7eebee)] - **doc**: add RafaelGSS as latest sec release stewards (Rafael Gonzaga) [#56682](https://github.com/nodejs/node/pull/56682)
* \[[`cccc3fd9ff`](https://github.com/nodejs/node/commit/cccc3fd9ff)] - **doc**: clarify cjs/esm diff in `queueMicrotask()` vs `process.nextTick()` (Dario Piotrowicz) [#56659](https://github.com/nodejs/node/pull/56659)
* \[[`ff6fcab68e`](https://github.com/nodejs/node/commit/ff6fcab68e)] - **doc**: `WeakSet` and `WeakMap` comparison details (Shreyans Pathak) [#56648](https://github.com/nodejs/node/pull/56648)
* \[[`a83952a49b`](https://github.com/nodejs/node/commit/a83952a49b)] - **doc**: mention prepare --security (Rafael Gonzaga) [#56617](https://github.com/nodejs/node/pull/56617)
...
* \[[`b7fe54fc88`](https://github.com/nodejs/node/commit/b7fe54fc88)] - **(SEMVER-MINOR)** **fs**: allow `exclude` option in globs to accept glob patterns (Daeyeon Jeong) [#56489](https://github.com/nodejs/node/pull/56489)
* \[[`8467b9a2eb`](https://github.com/nodejs/node/commit/8467b9a2eb)] - **http2**: omit server name when HTTP2 host is IP address (islandryu) [#56530](https://github.com/nodejs/node/pull/56530)
* \[[`445e81b411`](https://github.com/nodejs/node/commit/445e81b411)] - **inspector**: roll inspector\_protocol (Chengzhong Wu) [#56649](https://github.com/nodejs/node/pull/56649)
...
* \[[`793981a7fc`](https://github.com/nodejs/node/commit/793981a7fc)] - **lib**: ensure FORCE\_COLOR forces color output in non-TTY environments (Pietro Marchini) [#55404](https://github.com/nodejs/node/pull/55404)
...
* \[[`b8002b0e18`](https://github.com/nodejs/node/commit/b8002b0e18)] - **meta**: move one or more collaborators to emeritus (Node.js GitHub Bot) [#56580](https://github.com/nodejs/node/pull/56580)
...
* \[[`71c246d90f`](https://github.com/nodejs/node/commit/71c246d90f)] - **module**: fix jsdoc for `format` parameter in cjs/loader (pacexy) [#56501](https://github.com/nodejs/node/pull/56501)
* \[[`0ac7aa3b89`](https://github.com/nodejs/node/commit/0ac7aa3b89)] - **module**: unify TypeScript and .mjs handling in CommonJS (Joyee Cheung) [#55590](https://github.com/nodejs/node/pull/55590)
* \[[`b341af0202`](https://github.com/nodejs/node/commit/b341af0202)] - **module**: fix async resolution error within the sync `findPackageJSON` (Jacob Smith) [#56382](https://github.com/nodejs/node/pull/56382)
* \[[`a9d87028d3`](https://github.com/nodejs/node/commit/a9d87028d3)] - **module**: simplify `findPackageJSON` implementation (Antoine du Hamel) [#55543](https://github.com/nodejs/node/pull/55543)
* \[[`1d1f8804be`](https://github.com/nodejs/node/commit/1d1f8804be)] - **(SEMVER-MINOR)** **module**: add `findPackageJSON` util (Jacob Smith) [#55412](https://github.com/nodejs/node/pull/55412)
* \[[`d4014559d0`](https://github.com/nodejs/node/commit/d4014559d0)] - **module**: fix bad `require.resolve` with option paths for `.` and `..` (Dario Piotrowicz) [#56735](https://github.com/nodejs/node/pull/56735)
...
* \[[`6ad899033d`](https://github.com/nodejs/node/commit/6ad899033d)] - **process**: remove support for undocumented symbol (Antoine du Hamel) [#56552](https://github.com/nodejs/node/pull/56552)
* \[[`499a5cb563`](https://github.com/nodejs/node/commit/499a5cb563)] - **process**: fix symbol key and mark experimental new `node:process` methods (Antoine du Hamel) [#56517](https://github.com/nodejs/node/pull/56517)
* \[[`396a830df7`](https://github.com/nodejs/node/commit/396a830df7)] - **(SEMVER-MINOR)** **process**: add process.ref() and process.unref() methods (James M Snell) [#56400](https://github.com/nodejs/node/pull/56400)
* \[[`6e2eac533b`](https://github.com/nodejs/node/commit/6e2eac533b)] - **punycode**: limit deprecation warning (Colin Ihrig) [#56632](https://github.com/nodejs/node/pull/56632)
...
* \[[`b572d748e7`](https://github.com/nodejs/node/commit/b572d748e7)] - **src**: add nullptr handling from X509\_STORE\_new() (Burkov Egor) [#56700](https://github.com/nodejs/node/pull/56700)
* \[[`3c37dcf643`](https://github.com/nodejs/node/commit/3c37dcf643)] - **src**: add default value for RSACipherConfig mode field (Burkov Egor) [#56701](https://github.com/nodejs/node/pull/56701)
* \[[`a3054b87e5`](https://github.com/nodejs/node/commit/a3054b87e5)] - **src**: fix build with GCC 15 (tjuhaszrh) [#56740](https://github.com/nodejs/node/pull/56740)
* \[[`7393269bd2`](https://github.com/nodejs/node/commit/7393269bd2)] - **src**: fix to generate path from wchar\_t via wstring (yamachu) [#56696](https://github.com/nodejs/node/pull/56696)
* \[[`ae41e7b29f`](https://github.com/nodejs/node/commit/ae41e7b29f)] - **src**: initialize FSReqWrapSync in path that uses it (Michaël Zasso) [#56613](https://github.com/nodejs/node/pull/56613)
...
* \[[`90d092fb28`](https://github.com/nodejs/node/commit/90d092fb28)] - **test**: reduce number of written chunks (Luigi Pinca) [#56757](https://github.com/nodejs/node/pull/56757)
* \[[`b303837b2c`](https://github.com/nodejs/node/commit/b303837b2c)] - **test**: fix invalid common.mustSucceed() usage (Luigi Pinca) [#56756](https://github.com/nodejs/node/pull/56756)
* \[[`c12f8b3088`](https://github.com/nodejs/node/commit/c12f8b3088)] - **test**: use strict mode in global setters test (Rich Trott) [#56742](https://github.com/nodejs/node/pull/56742)
* \[[`ddeb97d182`](https://github.com/nodejs/node/commit/ddeb97d182)] - **test**: cleanup and simplify test-crypto-aes-wrap (James M Snell) [#56748](https://github.com/nodejs/node/pull/56748)
* \[[`258c5e5ab7`](https://github.com/nodejs/node/commit/258c5e5ab7)] - **test**: do not use common.isMainThread (Luigi Pinca) [#56768](https://github.com/nodejs/node/pull/56768)
* \[[`2052bd5395`](https://github.com/nodejs/node/commit/2052bd5395)] - **test**: make some requires lazy in common/index (James M Snell) [#56715](https://github.com/nodejs/node/pull/56715)
* \[[`27cf7b3c03`](https://github.com/nodejs/node/commit/27cf7b3c03)] - **test**: add test that uses multibyte for path and resolves modules (yamachu) [#56696](https://github.com/nodejs/node/pull/56696)
* \[[`84bd6d8577`](https://github.com/nodejs/node/commit/84bd6d8577)] - **test**: replace more uses of `global` with `globalThis` (James M Snell) [#56712](https://github.com/nodejs/node/pull/56712)
* \[[`3b375c01b6`](https://github.com/nodejs/node/commit/3b375c01b6)] - **test**: make common/index slightly less node.js specific (James M Snell) [#56712](https://github.com/nodejs/node/pull/56712)
* \[[`145546a66d`](https://github.com/nodejs/node/commit/145546a66d)] - **test**: rely less on duplicative common test harness utilities (James M Snell) [#56712](https://github.com/nodejs/node/pull/56712)
* \[[`39c1d09152`](https://github.com/nodejs/node/commit/39c1d09152)] - **test**: simplify common/index.js (James M Snell) [#56712](https://github.com/nodejs/node/pull/56712)
* \[[`588ec6fb10`](https://github.com/nodejs/node/commit/588ec6fb10)] - **test**: move hasMultiLocalhost to common/net (James M Snell) [#56716](https://github.com/nodejs/node/pull/56716)
* \[[`e5f0884f6b`](https://github.com/nodejs/node/commit/e5f0884f6b)] - **test**: move crypto related common utilities in common/crypto (James M Snell) [#56714](https://github.com/nodejs/node/pull/56714)
* \[[`c9879b25dc`](https://github.com/nodejs/node/commit/c9879b25dc)] - **test**: add missing test for env file (Jonas) [#56642](https://github.com/nodejs/node/pull/56642)
* \[[`31914b16a9`](https://github.com/nodejs/node/commit/31914b16a9)] - **test**: enforce strict mode in test-zlib-const (Rich Trott) [#56689](https://github.com/nodejs/node/pull/56689)
* \[[`6c19b80ba1`](https://github.com/nodejs/node/commit/6c19b80ba1)] - **test**: fix localization data for ICU 74.2 (Antoine du Hamel) [#56661](https://github.com/nodejs/node/pull/56661)
* \[[`743b0039ed`](https://github.com/nodejs/node/commit/743b0039ed)] - **test**: use --permission instead of --experimental-permission (Rafael Gonzaga) [#56685](https://github.com/nodejs/node/pull/56685)
* \[[`b2d444dff2`](https://github.com/nodejs/node/commit/b2d444dff2)] - **test**: test-stream-compose.js doesn't need internals (Meghan Denny) [#56619](https://github.com/nodejs/node/pull/56619)
...
* \[[`56be4eece8`](https://github.com/nodejs/node/commit/56be4eece8)] - **tools**: update doc to new version (Node.js GitHub Bot) [#56259](https://github.com/nodejs/node/pull/56259)
* \[[`b62415a5f0`](https://github.com/nodejs/node/commit/b62415a5f0)] - **tools**: update inspector\_protocol roller (Chengzhong Wu) [#56649](https://github.com/nodejs/node/pull/56649)
* \[[`86384ac63a`](https://github.com/nodejs/node/commit/86384ac63a)] - **tools**: do not throw on missing `create-release-proposal.sh` (Antoine du Hamel) [#56704](https://github.com/nodejs/node/pull/56704)
* \[[`2787700cfa`](https://github.com/nodejs/node/commit/2787700cfa)] - **tools**: fix tools-deps-update (Daniel Lemire) [#56684](https://github.com/nodejs/node/pull/56684)
* \[[`d8da1ec973`](https://github.com/nodejs/node/commit/d8da1ec973)] - **tools**: do not throw on missing `create-release-proposal.sh` (Antoine du Hamel) [#56695](https://github.com/nodejs/node/pull/56695)
...
* \[[`0dde9460b2`](https://github.com/nodejs/node/commit/0dde9460b2)] - **util**: inspect: do not crash on an Error stack that contains a Symbol (Jordan Harband) [#56573](https://github.com/nodejs/node/pull/56573)
...
* \[[`4ea2d91735`](https://github.com/nodejs/node/commit/4ea2d91735)] - **watch**: reload env file for --env-file-if-exists (Jonas) [#56643](https://github.com/nodejs/node/pull/56643)
* \[[`c2883f2706`](https://github.com/nodejs/node/commit/c2883f2706)] - **worker**: refactor stdio to improve performance (Matteo Collina) [#56630](https://github.com/nodejs/node/pull/56630)
